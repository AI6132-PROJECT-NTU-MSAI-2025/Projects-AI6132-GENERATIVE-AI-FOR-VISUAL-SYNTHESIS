...
def prepare_train_dataset(dataset, accelerator):
    ...
    with accelerator.main_process_first():
        dataset = dataset.cast_column(args.image_column, daIMG())             # <--- 关键修复点
...
if __name__ == "__main__":
    training_args = [
        ...
        #继续训练
        #"--resume_from_checkpoint","/check_points/checkpoint-20",

        # 训练参数
        "--resolution", "512",
        "--train_batch_size", "4",
        "--learning_rate", "1e-5",
        # 启用 action="store_true" 的标志
        ...
        "--mixed_precision", "no",  # 传递 choices 中的值
    ]
